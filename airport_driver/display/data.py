...
state_vital_components = {
    ...
    "state_seven":       {"day": ["RW6L", "gate"], "night": ["RW6L", "gate"]},
    "state_eight":       {"day": ["RW6L", "gate"], "night": ["RW6L", "gate"]},
    "state_nine":        {"day": ["RW6L", "fuel_depot", "gate"], "night": ["RW6L", "fuel_depot", "gate"]},
    "state_ten":         {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    "state_eleven":      {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    ...
    "state_sixteen":     {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    "state_seventeen":   {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    "state_eighteen":    {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    "state_nineteen":    {"day": ["taxiway", "gate"], "night": ["taxiway", "gate"]},
    "state_twenty":      {"day": ["RW6R", "gate"], "night": ["RW6R", "gate"]},
    "state_twenty_one":  {"day": ["RW6R", "gate"], "night": ["RW6R", "gate"]},
    "state_twenty_two":  {"day": ["RW6R", "gate"], "night": ["RW6R", "gate"]},
